...
public class ActivityDetailController {
    ...
    @GetMapping("/viewActivityDetail/{id}")
    public String viewActivityDetail(@PathVariable(value = "id") Long id, Model model) {
        ActivityDetail activityDetail = activityDetailService.getActivityDetailById(id);
        model.addAttribute("activityDetail", activityDetail);
        return "activityDetail/viewActivityDetail";
    }
